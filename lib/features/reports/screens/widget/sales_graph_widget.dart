...
class SalesGraphWidget extends ConsumerStatefulWidget {
  const SalesGraphWidget({Key? key}) : super(key: key);

  @override
  ConsumerState<SalesGraphWidget> createState() => _SalesGraphWidgetState();
}

class _SalesGraphWidgetState extends ConsumerState<SalesGraphWidget> {
          ...
          children: [
            Row(
              children: [
                ...
                SizedBox(width: 10.w,),
                Text("Prospects", style: Styles.smallGreyText(context).copyWith(fontWeight: FontWeight.w600),)
              ],
            ),
            SizedBox(width: 10.w,),
            Row(
