...
import 'package:nested_navigation_gorouter_example/utils/styles.dart';
 class ProspectsDetailsCard extends ConsumerStatefulWidget {
   final Color? color;
   final ProspectsModel customer;
   final double longitude;
   final double latitude;
   final double distance;
   const ProspectsDetailsCard({Key? key, this.color, required this.customer, required this.distance, required this.longitude, required this.latitude, }) : super(key: key);

   @override
   ConsumerState<ProspectsDetailsCard> createState() => _ProspectsDetailsCardState();
 }

 class _ProspectsDetailsCardState extends ConsumerState<ProspectsDetailsCard> {
