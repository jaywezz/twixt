...
class WonCustomerDetails extends ConsumerStatefulWidget {
  final bool isRetailProspect;
  final bool isCheckedIn;
  final ProspectsModel prospect;
  static const routeName = "won_customer_details";
  const WonCustomerDetails({super.key, required this.isRetailProspect, required this.prospect, required this.isCheckedIn });

  @override
  ConsumerState<WonCustomerDetails> createState() => _WonCustomerDetailsState();
}

class _WonCustomerDetailsState extends ConsumerState<WonCustomerDetails> {
  var plotId = 36478;
                                        ...
                                        InkWell(
                                          onTap: ()async{
                                            if(widget.prospect.phoneNumber == null){
                                              showCustomSnackBar("Phone number not provided", bgColor: Colors.blue);
                                            }else{
